								...
								<div className='mt-2.5 relative'>
									...
									{formik.errors.name && formik.touched.name && (
										<div className='mt-2 absolute left-[30%]'>
											<span className='bg-rose-500 relative shadow-md text-gray-900 border-rose-500 rounded-sm top-2 px-4 py-2 left-0 before:triangle before:absolute before:bottom-[2.25rem] before:left-2 animate-fade-down'>
							...
							<div className='sm:col-span-2'>
								...
								<div className='mt-2.5 relative'>
									...
									{formik.errors.subject && formik.touched.subject && (
										<div className='mt-2 absolute left-[30%]'>
											<span className='bg-rose-500 shadow-md relative text-gray-900 border-rose-500 rounded-sm top-2 px-4 py-2 left-0 before:triangle before:absolute before:bottom-[2.25rem] before:left-2 animate-fade-down'>
												<ExclamationTriangleIcon className='w-8 inline align-middle pr-2 text-amber-400' />
